...
int main() {
    ...
    printf("Enter coefficients and exponents for Polynomial P1:\n");
    t1 = readPoly(p1);
    printf("\nPolynomial P1(x): ");
    displayPoly(p1, t1);

    // Read and display second polynomial
    printf("\nEnter coefficients and exponents for Polynomial P2:\n");
    t2 = readPoly(p2);
    printf("\nPolynomial P2(x): ");
    displayPoly(p2, t2);
    ...
    printf("\n\nResultant polynomial P3(x) after addition: ");
    displayPoly(p3, t3);
...
int addPoly(struct poly p1[10], struct poly p2[10], int t1, int t2, struct poly p3[10]) {
    ...
    return k;  // returns the number of terms in the resultant polynomial p3
}
